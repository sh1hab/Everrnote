...
// const model = JSON.parse(JSON.stringify(props.question));
const model = props.question;
...
function setOptions(options){
    return model.data.options = options;
}
...
function removeOption(op){
    setOptions(getOptions().filter((option) => {
        return option!== op
    }));
    dataChange();
}
